...
// Create the Projects section Non-Refactored
...
//   const nonFeaturedProjects = projectsArr.filter((porject) => {
//     if (!project.feature) {
//       return true;
//     } else {
//       return false;
...
//       <h2 class="text-dark bg-primary p-2 display-inline-block">Work</h2v>
...
// The Refactored Projects Section
const generateProjects = (projectsArr) => {
  return `
    <section class="my-3" id="portfolio">
